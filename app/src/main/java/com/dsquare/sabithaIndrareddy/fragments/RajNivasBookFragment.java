...
public class RajNivasBookFragment extends Fragment
{
    ...
    private void initializeViews(View view)
    {
       ...
       // displayFromAsset();
        ...
        initWebView();
        webview.loadUrl("https://drive.google.com/gview?embedded=true&url=http://ifuture.us/LT_Uploads/RajNivasBook.pdf");
    }
